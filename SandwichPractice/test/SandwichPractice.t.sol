...
contract SandwichPracticeTest is SandwichSetUp {
    ...
    function _attackerAction1() internal {
        ...
        attackerGetUSDC =  usdc.balanceOf(address(attacker));
        console.log('attackerGetUSDC',attackerGetUSDC);
    ...
    function _attackerAction2() internal {
        ...
        usdc.approve(address(uniswapV2Router), attackerGetUSDC);
    ...
    function _checkAttackerProfit() internal {
        ...
        // 1 eth => 13721614697813279
        // 2 eth => 20408527294057866
        // 2.3 eth => 30874135451042564
        // 2.6 eth => 34726309006285706
        // 2.61 eth => 34854044809415283
        assertGt(profit, 0);
    }
}
